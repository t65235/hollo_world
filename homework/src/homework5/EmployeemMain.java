...
public class EmployeemMain {
	...
	一般職員 e01 =new 一般職員 ("王大明","男","100-1-1","0912345678","台灣",20000);
	System.out.println("當月薪水"+e01.當月薪水());
	一般職員 e02 =new 一般職員 ("王大明","男","100-1-1","0912345678","台灣",20000);
	e02.setHours(6);
	System.out.println("當月薪水"+e02.當月薪水());
	一般職員 e03 =new 二級主管 ("王大明","男","100-1-1","0912345678","台灣",20000,1800,3000);
	e03.setHours(6);
	System.out.println("當月薪水"+e03.當月薪水());
	一般職員 e04 =new 二級主管 ("王大明","男","100-1-1","0912345678","台灣",20000,1800,3000);
	System.out.println("當月薪水"+e04.當月薪水());
	一般職員 e05 =new 一級主管 ("王大明","男","100-1-1","0912345678","台灣",20000,1800,5000,2000);
	System.out.println("當月薪水"+e05.當月薪水());
	一般職員 e06 =new 一級主管 ("王大明","男","100-1-1","0912345678","台灣",20000,1800,5000,2000);
	e06.setHours(6);
